(function () {
    ...
    function Pa(a) {
        ...
        Qa.map(function (c, d) {
            if (d.F) {
                ...
                void 0 != e &&
                    e != d.defaultValue &&
                    ("boolean" == typeof e && (e *= 1), b.push(d.F + "=" + K("" + e)));
            }
        });
        b.push("z=" + Bd());
        a.set(Ra, b.join("&"), !0);
            ...
            if ("cookie" == P(a, ac)) {
                ...
                if ("auto" != e) zc(b, c, d, e, ca, g) && (hc = !0);
                    ...
                    a: {
                        ...
                        if (
                            4 == e.length &&
                            ((l = e[e.length - 1]), parseInt(l, 10) == l)
                        ) {
                            l = ["none"];
                            break a;
                        }
                    ...
                    for (var k = 0; k < l.length; k++)
                        if (
                            ((e = l[k]), a.data.set(W, e), (c = nd(a)), zc(b, c, d, e, ca, g))
                        ) {
                            hc = !0;
                            return;
                        }
    ...
    function Zc(a, b) {
        ...
        null == a
            ? (c = d = 1)
            : ((c = La(a)), (d = La(D(a, ".") ? a.substring(1) : "." + a)));
    ...
    var Jd = function (a, b, c) {
        ...
        Pd = function (a, b) {
            b.get(a.U) ||
                ("1" == Ca(a.Y)[0] ? b.set(a.U, "", !0) : b.set(a.U, "" + hd(), !0));
        },
        Qd = function (a, b) {
    ...
    var wb = /^(UA|YT|MO|GP)-(\d+)-(\d+)$/,
        ...
        Jc = function (a, b) {
            ...
            if (
                (e =
                    (c = M.location[c ? "href" : "search"].match(
                        "(?:&|#|\\?)" +
                        K("_ga").replace(/([.*+?^=!:${}()|\[\]\/\\])/g, "\\$1") +
                        "=([^&#]*)"
                    )) && 2 == c.length
                    ...
                    if (a.i) {
                        ...
                        ea(g)
                            ? ((b.plugins_ = b.plugins_ || new ee()),
                                b.plugins_.get(d) || b.plugins_.set(d, new g(b, e || {})),
                                (c = !0))
                            : (c = !1);
                        if (!c) return !0;
                    } else if (a.K) {
